...
type Page = 'landing' | 'login' | 'signup' | 'discover' | 'books' | 'summary' | 'library' | 'premium' | 'about' | 'terms' | 'privacy';
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-[#FDC448] to-[#E3762B] items-center justify-center p-12">
        <div className="text-center text-white max-w-md">
          ...
          <h2 className="text-4xl mb-4">Start Your Journey</h2>
          <p className="text-xl text-white/90">
            Join thousands of readers who are learning faster with Kualala. Baca buku nggak ribet!
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-sm">
              <label className="flex items-start gap-2 text-gray-600 dark:text-gray-400">
